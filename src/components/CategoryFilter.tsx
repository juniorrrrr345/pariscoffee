      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 p-4 sm:p-5 max-w-7xl mx-auto">
        ...
        <div className="relative flex-1" ref={categoryRef}>
          ...
          {showCategories && (
            <div className="absolute top-full left-0 right-0 mt-3 bg-gradient-to-b from-gray-900 to-black backdrop-blur-2xl rounded-2xl shadow-2xl z-[9999] border border-blue-500/20 overflow-hidden animate-fadeIn">
              ...
              <div className="max-h-72 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-500/30 scrollbar-track-transparent">
        ...
        <div className="relative flex-1" ref={farmRef}>
          <button
            ...
            className="w-full bg-gradient-to-r from-green-600/20 to-emerald-600/20 hover:from-green-600/30 hover:to-emerald-600/30 border border-green-500/30 hover:border-green-500/50 text-white py-3.5 px-5 rounded-2xl text-sm font-semibold transition-all duration-300 flex items-center justify-between shadow-xl hover:shadow-green-500/20 transform hover:scale-[1.02] backdrop-blur-md group"
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-green-500/50 transition-all">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
              </div>
              <span className="truncate text-base">{selectedFarm}</span>
            </div>
