    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-black text-white mb-2">PARISCOFFEE</h1>
          <p className="text-gray-300">Panneau d'administration</p>
        </div>

        {/* Formulaire de connexion */}
        <div className="bg-black/30 backdrop-blur-sm rounded-lg p-8 max-w-md w-full mx-4">
